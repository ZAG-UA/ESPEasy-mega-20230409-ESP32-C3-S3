...
#ifdef ESP32
 #ifdef CONFIG_IDF_TARGET_ESP32S2		// ESP32-S2
...
const __FlashStringHelper * getResetReasonString_f(uint8_t icore, bool& isDEEPSLEEP_RESET) {
  ...
  switch (rtc_get_reset_reason((RESET_REASON)icore)) {
    ...
    case EFUSE_RESET:            return F("EFUSE_RESET");                                      // 20 FIXME TD-er: No idea what may cause this
  #if defined(CONFIG_IDF_TARGET_ESP32C3) ||  defined(CONFIG_IDF_TARGET_ESP32S3)
    case USB_UART_CHIP_RESET:    return F("USB uart reset digital core");                      // 21
    case USB_JTAG_CHIP_RESET:    return F("USB jtag reset digital core");                      // 22
    case POWER_GLITCH_RESET:     return F("Power glitch reset digital core and rtc module");   // 23
  #endif // if defined(CONFIG_IDF_TARGET_ESP32C3) ||  defined(CONFIG_IDF_TARGET_ESP32S3)
