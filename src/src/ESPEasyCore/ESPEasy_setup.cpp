...
//    BOOT_MODE_GET();
  ...
  if (UseRTOSMultitasking) {
    if (loglevelActiveFor(LOG_LEVEL_INFO)) {
      ...
      addLog(LOG_LEVEL_INFO, F("RTOS : Launching tasks to UniCore"));
#else // ifndef CONFIG_FREERTOS_UNICORE
      addLog(LOG_LEVEL_INFO, F("RTOS : Launching tasks to MultiCore"));
#endif // ifndef CONFIG_FREERTOS_UNICORE
    }
    xTaskCreateUniversal(RTOS_TaskServers, "RTOS_TaskServers", 16384, nullptr, 2, nullptr, 1);
    xTaskCreateUniversal(RTOS_TaskSerial,  "RTOS_TaskSerial",  8192,  nullptr, 1, nullptr, 1);
#ifndef CONFIG_FREERTOS_UNICORE
    xTaskCreateUniversal(RTOS_Task10ps,    "RTOS_Task10ps",    8192,  nullptr, 2, nullptr, 0);
#endif // ifndef CONFIG_FREERTOS_UNICORE
