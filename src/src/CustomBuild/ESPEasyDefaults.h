...
#define DEFAULT_NAME        "ESP_Easy_32C3"     // Enter your device friendly name
#elif CONFIG_IDF_TARGET_ESP32S2
#define DEFAULT_NAME        "ESP_Easy_32S2"     // Enter your device friendly name
#elif CONFIG_IDF_TARGET_ESP32S3
#define DEFAULT_NAME        "ESP_Easy_32S3"     // Enter your device friendly name
#else // if CONFIG_IDF_TARGET_ESP32C3
#define DEFAULT_NAME        "ESP_Easy_32"       // Enter your device friendly name
...
#define DEFAULT_WIFI_NONE_SLEEP          true   // When set, the wifi will be set to no longer sleep (more power used and need reboot to reset mode)
#endif
